import { equipmentCardSchema, type EquipmentCard } from './schemas.js';
    ...
    exerciseVariants: [
      {
        ...
        steps: ['双臂打开到胸部有轻微拉伸。', '像拥抱一样向中间夹拢。', '在中间停顿一秒，再慢慢还原。'],
        safety: ['肩前侧不舒服时缩小打开幅度。', '手肘保持微屈，不要完全伸直硬顶。'],
        commonErrors: ['借惯性猛夹。', '肩膀前顶，导致胸肌发力变弱。'],
      ...
      },
      {
        ...
        secondaryMuscles: ['菱形肌', '斜方肌中下束'],
        summary: '反向坐姿使用蝴蝶机，训练肩后束和上背部控制。',
        adjustment: '面向靠垫坐下，让胸口贴稳靠垫，把手高度调到肩膀附近。',
        steps: ['双手握住把手，肩膀下沉。', '用肘部带动双臂向身体两侧打开。', '打开到肩后侧收紧后，控制回到起点。'],
        safety: ['不要耸肩或甩动身体。', '重量不要太大，避免用斜方肌和腰背代偿。'],
        commonErrors: ['手臂伸得太直，变成手腕在拉。', '身体离开靠垫借力后摆。'],
    ...
    exerciseVariants: [
      {
        ...
        targetLabel: '背阔肌宽度',
        primaryMuscles: ['背阔肌'],
        secondaryMuscles: ['肱二头肌', '大圆肌'],
        summary: '通过较宽握距学习背阔肌下拉发力，适合新手建立背部宽度训练感觉。',
        adjustment: '腿垫压稳大腿，握距略宽于肩，身体微微后仰但不要躺倒。',
        steps: ['先沉肩，让肩膀远离耳朵。', '用肘部向身体两侧下拉，把横杆拉到锁骨附近。', '控制横杆回到顶部，让背部被拉长。'],
        safety: ['不要拉到脖子后面。', '不要大幅后仰借力。'],
        commonErrors: ['先弯手臂而不是先沉肩。', '每次回程都耸肩放松。'],
      ...
      },
      {
        ...
        steps: ['先沉肩并收紧核心。', '把握把拉向上胸或锁骨下方。', '夹紧背部后慢慢放回起点。'],
        safety: ['手腕保持中立，不要硬掰。', '不要用身体后仰把重量甩下来。'],
        commonErrors: ['只用二头肌硬拉。', '底部过度挺腰顶胸。'],
    ...
    exerciseVariants: [
      {
        ...
        steps: ['先沉肩并保持胸口稳定。', '用肘部向后下方带，把把手拉向下腹。', '控制回程，让背阔肌被拉长。'],
        safety: ['腰背保持稳定，不要前后甩。', '回程不要突然塌肩。'],
        commonErrors: ['把手拉得太高变成耸肩划船。', '身体后仰代替背部发力。'],
      ...
      },
      {
        ...
        targetLabel: '上背',
        primaryMuscles: ['菱形肌', '斜方肌中下束'],
        secondaryMuscles: ['后三角肌', '背阔肌'],
        summary: '用较高肘位向胸下方划船，更偏向上背部和肩胛控制。',
        adjustment: '把胸垫调稳，选择较宽或中等握距，让把手能拉向胸下方。',
        steps: ['肩膀下沉，胸口贴稳支撑。', '肘部向外后方打开，把把手拉向胸下方。', '肩胛轻轻夹紧后控制回程。'],
        safety: ['不要耸肩夹脖子。', '不要为了夹肩胛过度挺腰。'],
        commonErrors: ['肘部过低导致又变成背阔肌主导。', '顶端用斜方肌耸肩代偿。'],
    ...
    exerciseVariants: [
      {
        ...
        steps: ['膝盖跟随脚尖方向下放。', '下放到腰背仍能贴稳靠垫的位置。', '脚掌踩实，把踏板推回但不要锁死膝盖。'],
        safety: ['腰部不要离开靠垫。', '膝盖不要内扣。'],
        commonErrors: ['脚位太低导致膝盖不舒服。', '顶端完全锁死膝盖。'],
      ...
      },
      {
        ...
        targetLabel: '臀腿',
        primaryMuscles: ['臀大肌'],
        secondaryMuscles: ['腘绳肌', '股四头肌'],
        summary: '脚位略高、下放受控，更偏向臀部和腿后侧参与。',
        adjustment: '双脚放在踏板中部略偏高的位置，保持脚跟能稳定发力。',
        steps: ['缓慢下放，让臀部和腿后侧有拉伸。', '脚跟踩稳向上推。', '顶端收紧臀部但不要腰部离垫。'],
        safety: ['不要下放到骨盆后卷。', '不要为了深度牺牲腰背稳定。'],
        commonErrors: ['脚位太高导致活动范围很小。', '用腰去顶而不是用臀腿推。'],
      ...
      },
      {
        ...
        steps: ['脚跟缓慢下沉到小腿被拉伸。', '踮起脚尖把踏板推远。', '顶端停顿后慢慢回到拉伸位。'],
        safety: ['确认脚掌不会从踏板滑落。', '不要用弹震完成动作。'],
        commonErrors: ['只做很小半程。', '膝盖反复弯伸代替脚踝发力。'],
    ...
    exerciseVariants: [
      {
        ...
        steps: ['从身体前屈位开始。', '用下背和臀部一起把躯干抬到接近直线。', '停顿后慢慢下放。'],
        safety: ['顶端不要过度后仰。', '颈部保持中立。'],
        commonErrors: ['抬到顶端继续折腰。', '速度太快导致下背不适。'],
      ...
      },
      {
        ...
        steps: ['下放时让髋部折叠，背部保持稳定。', '脚跟踩稳，用臀部带动身体抬起。', '到身体接近直线时收紧臀部后下放。'],
        safety: ['不要用腰猛甩起来。', '不要顶端过度反弓。'],
        commonErrors: ['全程圆背导致下背压力大。', '只抬头挺胸而没有髋伸。'],
    ...
    exerciseVariants: [
      {
        ...
        steps: ['先沉肩并收紧核心。', '向上拉到下巴接近把手高度。', '控制身体下降到底部但不要塌肩。'],
        safety: ['上下膝垫时扶稳把手。', '不要突然松手让膝垫弹回。'],
        commonErrors: ['把辅助重量逻辑理解反。', '底部完全放松肩膀。'],
      ...
      },
      {
        ...
        steps: ['肩膀下沉，身体稳定在双杠上方。', '手肘弯曲，缓慢下放到舒适深度。', '向下压把手，把身体推回起点。'],
        safety: ['肩前侧不适时缩小下放幅度。', '不要在底部突然反弹。'],
        commonErrors: ['肩膀耸起挤压。', '身体晃动太大。'],
    ...
    exerciseVariants: [
      {
        ...
        steps: ['解锁安全把手。', '膝盖跟随脚尖方向下蹲。', '脚掌踩实推回起点但不要锁死膝盖。'],
        safety: ['膝盖不要内扣。', '不要在底部失控反弹。'],
        commonErrors: ['脚跟抬起。', '为了深度导致腰背离开靠垫。'],
      ...
      },
      {
        ...
        targetLabel: '臀腿',
        primaryMuscles: ['臀大肌'],
        secondaryMuscles: ['股四头肌', '腘绳肌'],
        summary: '脚位略高并控制下放，更偏向臀部和整体臀腿发力。',
        adjustment: '脚位放得比股四头肌版本略高，脚跟稳定贴住踏板。',
        steps: ['缓慢下蹲到臀腿有拉伸。', '脚跟和全脚掌踩实向上推。', '顶端收紧臀部但不要过度挺腰。'],
        safety: ['不要下蹲到骨盆失控卷起。', '不要用腰部顶起身体。'],
        commonErrors: ['脚位过高导致动作幅度太小。', '膝盖方向和脚尖不一致。'],
