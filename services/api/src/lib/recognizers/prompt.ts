...
export function buildRecognitionPrompt(source: 'camera' | 'album') {
  ...
  return [
    ...
    'Be especially careful with confusing pairs: pec-deck-fly vs seated-row, seated-chest-press vs shoulder-press, lat-pulldown vs seated-row, pec-deck-fly vs assisted-pull-up-dip.',
    'Do not return assisted-pull-up-dip unless the photo clearly shows a knee pad/platform plus dip handles or pull-up handles.',
    'pec-deck-fly is likely when the machine has a seat/back pad and two chest-height swing arms or forearm pads, with no knee pad/platform for assisted pull-ups.',
